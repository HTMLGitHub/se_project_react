...
export default function AddItemModal({
  ...
  return (
    ...
    >
      ...
      <label
        htmlFor="imageURL"
        className={`modal__label ${imageUrlError ? "modal__label_error" : ""}`}
      >
      ...
      <fieldset className="modal__radio-buttons">
        ...
        <div className="modal__radio-button">
          <label htmlFor="hot" className={`modal__label modal__label_type_radio ${weatherType==="hot" ? "modal__button_checked" : ""}`}>
            <input
        ...
        <div className="modal__radio-button">
          <label
            htmlFor="warm"className={`modal__label modal__label_type_radio ${weatherType==="warm" ? "modal__button_checked" : ""}`}>
            <input
              className="modal__input_radio_button"
              type="radio"
              name="weather"
        ...
        <div className="modal__radio-button">
          <label
            htmlFor="cold"
            className={`modal__label modal__label_type_radio ${weatherType==="cold" ? "modal__button_checked" : ""}`}>
            <input
              className="modal__input_radio_button"
              type="radio"
              name="weather"
